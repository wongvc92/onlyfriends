...
export const getConversation = async (currentUserId: string, peopleId: string): Promise<{ id: string }> => {
...
export const createConversation = async (currentUserId: string, peopleId: string): Promise<{ id: string }> => {
...
export const getAllConversations = async (currentUserId: string, query?: string): Promise<Iconversation[]> => {
