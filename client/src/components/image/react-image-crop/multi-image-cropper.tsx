...
const MultiImageCropper = ({ onChange, src, setImages, onClose, cropIndex }: MultiImageCropperProps) => {
  ...
  return (
    <>
      <ReactCrop crop={crop} onChange={(pixelCrop, percentCrop) => setCrop(percentCrop)} aspect={undefined}>
